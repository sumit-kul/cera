...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<meta name="description" content="Add or edit a blog entry in communityEra" />
		<meta name="keywords" content="Jhapak, blog, edit-blog, add-blog, how-to" />
		<title>Jhapak - ${command.blogActionLabel} blog entry</title>
		<link rel="icon" type="image/png" href="img/link_Image.png"/>
		<meta name="author" content="Jhapak">
		<link rel="canonical" href="${communityEraContext.contextUrl}/blog/addEditBlog.do" />
		...
		<script type="text/javascript">
			...
			$(document).ready(function () {
				$.ajax({url:"${communityEraContext.contextUrl}/common/userPannel.ajx?blogId=${command.communityBlog.id}",dataType: "json",success:function(result){
					var temp = "";
						 	...
						 	<div class="innerBlock">
								<form:form showFieldErrors="true" commandName="command" multipart="true" name="submitBlogEntry">
									...
									<form:errors message="Please correct the errors below" cssClass="errorText" /> <br />
											<label for="title">Title (100 characters max.) <img src="img/required.gif" title="This field is required" width="8" height="8" class="required" /></label>
											<br />
											<form:input id="title" path="title" cssClass="editor" maxlength="100" />
											<br /><br />
											...
											<c:if test="${command.id == 0}">
												<div class="left" style="margin-bottom: 20px;">
													<a href="javascript:void(0);" onclick="submitBlog();" class="btnmain" style="float:right;"><i class="fa fa-check" style="margin-right: 4px;"></i>Submit entry</a>
												</div>
											</c:if>	
											<c:if test="${command.id > 0}">
												<div class="left" style="margin-bottom: 20px;">
													<a href="javascript:void(0);" onclick="submitBlog();" class="btnmain" style="float:right;"><i class="fa fa-check" style="margin-right: 4px;"></i>Update entry</a>
												</div>
											</c:if>
										</form:form>
									</div>
