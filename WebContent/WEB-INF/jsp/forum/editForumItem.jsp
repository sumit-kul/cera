					...
					<div class="inputForm">
				 		<div class="innerBlock">
							<form:form showFieldErrors="true" commandName="command" multipart="true" name="submitTopicAction">
								...
								<label for="subject">Topic subject (100 characters max.) <img src="img/required.gif" title="This field is required" width="8" height="8" class="required" /></label>
								<br />
								<form:input path="subject" cssClass="editor" maxlength="100"/>
								<br /><br />
