					...
					<div class="inputForm">
				 		<div class="innerBlock">
							<form:form showFieldErrors="true" commandName="command" multipart="true" name="submitTopicAction">
								...
								<label for="subject">Topic subject (100 characters max.) <img src="img/required.gif" width="8" height="8" class="required" /></label>
								<br />
								<form:input path="subject" cssClass="editor" />
								<br /><br />
								<label for="title">Topic</label>
								<textarea class="ckeditor" name="body" ></textarea>
							
								<%-- <div class="tagOutLine" style="margin-top: 12px; padding: 0px 0px 10px 10px;width:680px;">
								...
								<div style="float: right;">
									<a href="javascript:void(0);" onclick="submitTopic();" class="btnmain" ><i class="fa fa-check" style="margin-right: 4px;"></i>Submit topic</a>
								</div>
							</form:form>
						</div>
						</div>
