...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<meta name="keywords" content="Jhapak, connection, community members, invitation, community, ${communityEraContext.currentCommunity.keywords}" />
		<title>${communityEraContext.currentCommunity.name}'s invitations - Jhapak</title>
		...
		<script type="text/javascript">
			...
			{ 
	            ...
	            onshown: function(dialogRef){
						...
						sName += "<p class='addListHead' >Add members or admin to this community by name or email address.</p>";
