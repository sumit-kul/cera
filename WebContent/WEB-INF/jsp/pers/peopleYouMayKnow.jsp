		...
		<div id="container" >
			<div class="left-panel" style="margin-top: -11px;">
				...
				<div class="commSection">
					<div class="nav-list" style="margin-top: 10px;">
						<ul>
					...
					<div class="communities">
						...
						<span class='pymk'>People You May Know</span>
					</div>
					
					<div class="inputForm" style="display: inline-block; width: 100%; padding: 0px;" id="">
						<div id="innerSection">
							<c:forEach items="${command.scrollerPage}" var="row">
								...
								<div ${trclass} id='connResult-${row.id}'>
									...
									<div class='details'>
								 	...
								 	<div id='connectionInfo-${row.id}' class='connectionInfo' style='top: 84px; right: 6px;'>${row.connectionInfo}</div>
								</div>
							</c:forEach>
						</div>
