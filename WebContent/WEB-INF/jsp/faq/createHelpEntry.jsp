...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<script type="text/javascript">
			function saveFAQ(){
				document.submitFAQEntry.action = "${communityEraContext.contextUrl}/faq/helpEntryCreate.do";
			...
			<div class="left-panel">
				<div class="breadcrum">
					<ul>
						...
						<li class="uppercase">New Help Menu Entry</li>
					</ul>
				</div>
					...
					<div class="inputForm">
						...
						<form:form showFieldErrors="true" commandName="command" multipart="true" name="submitFAQEntry">
							...
							<form:hidden path="id"/>
								...
								<br />
								<form:input path="question" cssClass="editor" cssStyle="width: 670px; margin: 10px 0px 20px 0px;"/>
								<br />
								<label for="answer">Answer:</label>
								<br />
								<form:textarea cssClass="ckeditor" path="answer" id="answer"></form:textarea>
								<br />
