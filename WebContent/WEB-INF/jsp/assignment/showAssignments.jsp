...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<meta name="keywords" content="Jhapak, Assignments, Tasks, TODO, TO-DO, Activity, community, ${communityEraContext.currentCommunity.keywords}" />
		...
		$(document).ready(function(){
			...
			if(${command.pageCount} > 0){
				$("#pagination").jPaginator({ 
					...
					$.ajax({url:"${communityEraContext.currentCommunityUrl}/assignment/showAssignments.do?jPage="+num+"&sortByOption="+$("#sortByOption").val(),dataType: "json",success:function(result){
						var sName = "";
						 $.each(result.aData, function() {
							 ...
							 sName += "<div class='paginatedList'><div class='leftImg'>";
								 ...
								 if(this['photoPresent'] == "Y"){
									 sName += "<a href='${communityEraContext.contextUrl}/pers/connectionResult.do?id="+this['creatorId']+"&backlink=ref' title='"+this['assigner']+"'>";
									 sName += "<img src='${communityEraContext.contextUrl}/pers/userPhoto.img?id="+this['creatorId']+"' style='height: 40px; width: 40px;'/></a>"; 
								 } else {
									 sName += "<img src='img/user_icon.png' style='height: 40px; width: 40px;' title='"+this['assigner']+"' />";
								 }
							 ...
							 sName += "<a href='${communityEraContext.currentCommunityUrl}/assignment/showAssignment.do?backlink=ref&amp;id="+rowId+"' >"+this['title']+"</a></div>";
							 sName += "<div class='person'>";
							 sName += "<span title='Created: "+this['postedOnHover']+"'>"+this['postedOn'] + "</span><i class='fa fa-circle' style='margin: 0px 8px; font-size: 6px;'></i><span title='Due: "+this['dueOnHover']+"'>Due "+this['dueOn']+"</span>";
							 sName += "<i class='a-icon-text-separator'></i> "+this['entryCount'] + " entries";
							 sName += "<i class='a-icon-text-separator'></i> "+this['toDoCount'] + " ToDos</div>";
							...
							<ul id="gn-menu" class="gn-menu-main">
								...
								<li>
									<nav id="menu">
							    		...
							    		<label id="toggle-nav-label" for="toggle-nav"><i class="fa fa-bars" style="padding: 10px;"></i></label>
							    		<div class="box">
								    		<ul>
							...
							<div class='actions2' id='connectionInfo'>
								<div class='btngroup' >
									<c:if test="${command.member}">
										<div class='btnout' id='comaction1'><a href="${communityEraContext.currentCommunityUrl}/assignment/createAssignment.do" class="normalTip"
											title="Create a new assignment">Create New Assignment</a></div>
										<div class='btnout' id='comaction2'><a href="${communityEraContext.currentCommunityUrl}/assignment/createAssignment.do" class="normalTip"
											title="Create a new assignment"><i class="fa fa-briefcase" style="font-size: 14px;"></i>
