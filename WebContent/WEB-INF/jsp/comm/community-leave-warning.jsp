...
<form:form showFieldErrors="true">
	...
	<div class="padding">
		...
		<div id="main">
		<p id="breadcrumb">
					<%@ include file="/WEB-INF/jspf/community-breadcrumb-start.jspf" %>Leave community warning
			...
			<h2 class="header">Warning</h2>
				<strong>You will no longer be a member of this community, have access to community content or receive email alerts when new content is published to this community.</strong>
				<div class="hr"><hr /></div>
