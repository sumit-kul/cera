	...
	<div class="padding">
		...
		<div id="main">
			...
			<p id="breadcrumb">
					...
					<a href="${communityEraContext.currentCommunityUrl}/wiki/showWikiEntries.do" class="backarrow">Wiki</a>
			...
			<div id="columnmain" class="forum">
				...
				<ul id="forumnav">
					<li><a href="${communityEraContext.currentCommunityUrl}/wiki/showWikiEntries.do" class="backarrow">Back to wiki</a></li>
				</ul>
				
				<dl>
					<dt>Wiki page deleted</dt>
					<dd><p>The wiki page has been deleted. <a href="${communityEraContext.currentCommunityUrl}/wiki/showWikiEntries.do">Click here to return to the wiki</a>.</p></dd>
