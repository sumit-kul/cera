	...
	<div class="padding">
		...
		<div id="main">
			...
			<div id="columnmain">
				...
				<dl>
					<dt>You are now unsubscribed from email alerts for the wiki pages in this community</dt>
					<dd><p>You will no longer receive email alerts when new pages are added to thsi wiki.
					<br/> <a href="${communityEraContext.currentCommunityUrl}/wiki/showWikiEntries.do?id=${command.id}"><br/>Click here to return to the wiki</a>.</p></dd>
