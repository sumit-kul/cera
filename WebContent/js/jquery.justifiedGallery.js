  ...
  */
  ...
  $.fn.justifiedGallery = function (arg) {
    ...
    function onEntryMouseEnterForCaption (ev) {
      ...
      var entryId = $caption.attr('id');
	         $('#dynaDropDown_'+entryId).qtip({
	            content: {
	                text: function(event, api) {
	                    $.ajax({
	                        url: api.elements.target.attr('oldtitle'), // Use href attribute as URL
    ...
    function displayEntry($entry, x, y, imgWidth, imgHeight, rowHeight, context) {
      ...
      if (context.settings.captions === true) {
        ...
        if ($imgCaption.length === 0) { // Create it if it doesn't exists
          ...
          var entryId = $image.attr('id');
          var albumId = $image.attr('oldtitle');
          var move = $image.attr('allowed');
          if (typeof caption === 'undefined') caption = $entry.attr('title');
          if (typeof caption !== 'undefined') { // Create only we found something
            $imgCaption = $('<div class="caption" id="'+entryId+'">' + caption + '<a href="javascript:void(0)" id="dynaDropDown_'+entryId+'" class="dynaDropDown" title="community/communityOptions.ajx?imageId='+entryId+'&albumId='+albumId+'&moveToAlbumAllowed='+move+'" ><span class="captionEdit"/></a></div>');
