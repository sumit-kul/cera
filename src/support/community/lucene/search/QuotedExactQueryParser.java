...
public class QuotedExactQueryParser implements QueryParserConstants 
{
   ...
   */
  public QuotedExactQueryParser(String f, Analyzer a) {
...
//         q = getFieldQuery(field, term.image.substring(1, term.image.length()-1), s); 
         q = getFieldQuery(field, term.image, s);
      break;
    default:
      jj_la1[21] = jj_gen;
      jj_consume_token(-1);
  ...
  public QuotedExactQueryParser(CharStream stream) {
  ...
  public QuotedExactQueryParser(QueryParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
