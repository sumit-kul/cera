...
public class StringHelper {
    ...
    /*
     * Allows display of hyper links as clickable links and changes nl to <br>
     */
    ...
    {   
         ...
         //s = s.replaceAll("\r\n","<br />");
         //s = s.replaceAll("\n"," ");
         s = s.replaceAll("([ >])(http://[^ <]*)", "$1<a href=\"$2\"  target=_blank>$2</a>");
         s= s.replaceAll("([ >])(www\\.[^ <]*)", "$1<a href=\"http://$2\" target=_blank>$2</a>");
         s=s.replaceAll("<code>", "<xmp><code>");
         s=s.replaceAll("</code>", "</code></xmp>");
         //s=s.replaceAll("<pre>", "<xmp><pre>");
         //s=s.replaceAll("</pre>", "</pre></xmp>");
         return  s;
    }
}
