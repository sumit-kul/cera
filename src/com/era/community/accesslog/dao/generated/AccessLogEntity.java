...
public abstract class AccessLogEntity extends support.community.framework.CommandBeanImpl
{
		  ...
		  private int Id;
		  public final java.lang.String getItemType() { return ItemType; }
		  public final void setItemType(java.lang.String v) {  ItemType = v; }
		  public final int getItemId() { return ItemId; }
		  public final void setItemId(int v) {  ItemId = v; }
