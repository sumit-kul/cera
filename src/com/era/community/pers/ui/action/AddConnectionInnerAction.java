 ...
 * 
 * @spring.bean name="/pers/addConnectionInner.ajx"
 */
public class AddConnectionInnerAction extends AbstractCommandAction
{
    ...
    protected ModelAndView handle(Object data) throws Exception    
    {
        ...
        String returnString = "<span class='dynaDropDown' title='pers/connectionOptions.ajx?connId="+cmd.getId()+"&currId="+currentUser.getId()+"&userName="+cmd.getUserName()+"'>Request Sent</span>";
