...
/**
 * @spring.bean name="/cid/[cec]/community/changeToPublic.do" 
 */
public class ChangeToPublicAction extends AbstractCommandAction
{
    ...
    protected ModelAndView handle(Object data) throws Exception
    {
        ...
        if (community.getCommunityType().equalsIgnoreCase("Private") || community.getCommunityType().equalsIgnoreCase("Protected")) {
            community.setSysType(community, "PublicCommunity");
        }
